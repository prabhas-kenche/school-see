                ...
                children: [
                  ...
                  CircleAvatar(
                    ...
                    backgroundImage: const NetworkImage(
                      'https://assets.onecompiler.app/42ucesb3u/42wr2w44q/image%20(2).png',
                    ),
                  ),
                ],
              ),
                  ...
                  children: [
                    _DashboardCard(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const DigitalClassesScreen()),
                        );
                      },
                    ),
                    _DashboardCard(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const FeeStatusScreen()),
                        );
                      },
                    ),
                    _DashboardCard(
